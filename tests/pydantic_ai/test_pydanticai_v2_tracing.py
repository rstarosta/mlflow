...
from mlflow.pydantic_ai import _is_pydantic_ai_v2
from mlflow.pydantic_ai.autolog_v2 import _get_span_type
...
def test_v2_dispatch_and_auto_instrumentation():
    assert _is_pydantic_ai_v2()
